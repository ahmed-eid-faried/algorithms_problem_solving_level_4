...
namespace soln18 {
	...
	sDate ReadDate() {
		sDate Date;
		Date.Day = soln18::ReadNumberInRange(1, 31, "Please Enter a Day? ");
		Date.Month = soln18::ReadNumberInRange(1, 12, "Please Enter a Month? ");
		Date.Year = soln18::ReadNumber("Please Enter a Year? ");
		return Date;
	}
