...
namespace soln17_2 {
	...
	sDate ReadDate() {
		sDate Date;
		Date.Day = soln17_2::ReadNumberInRange(1, 31, "Please Enter a Day? ");
		Date.Month = soln17_2::ReadNumberInRange(1, 12, "Please Enter a Month? ");
		Date.Year = soln17_2::ReadNumber("Please Enter a Year? ");
		return Date;
	}
...
void Differance2DateEx2() {
	cout << "Date1: " << endl;
	soln17_2::sDate Date1 = soln17_2::ReadDate();
	cout << "Date2: " << endl;
